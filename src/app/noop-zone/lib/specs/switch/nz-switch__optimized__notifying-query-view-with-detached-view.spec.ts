  ...
  template: `
    <ng-container *nzQueryView="queryViewPriority">
      <div testDir [nzSwitch]="value" [priority]="priority">
        ...
        <div *nzDetachedView="detachedViewPriority">
...
function setupEnviroment(): void {
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [ NzSwitchModule, NzQueryViewModule, NzDetachedViewModule ],
...
for (let prio = 1; prio < 6; prio++) {
  describe(`[nzSwitch] Optimized: Notifying query view with detached view. Priority level ${prio}.`, () => {
    ...
    describe('Observables. Using waitUntilSchedulingDone() function.', () => {
      ...
      it('Should render the right view.', async () => {
        ...
        expect(component.testDir.checkCount).toEqual(10);
