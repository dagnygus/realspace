...
import { NzDetachedViewModule, NzQueryViewModule } from "../../template";
...
function setupEnviroment(): void {
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [ NzLocalViewModule, NzQueryViewModule, NzDetachedViewModule ],
...
for (let prio = 1; prio < 6; prio++) {
  describe(`[nzLocalView]: Notifying query view with detached view. Priority level ${prio}.`, () => {
