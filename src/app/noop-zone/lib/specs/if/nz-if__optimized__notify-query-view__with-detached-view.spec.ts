...
import { NzDetachedViewDirective } from "../../template/detached-view/detached-view.directive";
...
function setupEnviroment(): void {
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [ NzIfModule, NzQueryViewModule, NzDetachedViewDirective ],
...
describe('[nzIf] optimized. Notifying query view with detached view.', () => {
