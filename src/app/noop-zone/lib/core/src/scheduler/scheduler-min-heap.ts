...
function siftUp(heap: Heap, node: ReactSchedulerTask, i: number) {
  let index = i;
...
function siftDown(heap: Heap, node: ReactSchedulerTask, i: number) {
  let index = i;
...
function compare(a: ReactSchedulerTask, b: ReactSchedulerTask) {
